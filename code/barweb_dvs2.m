function handles = barweb_dvs(barvalues, errors, width, groupnames, bw_title, bw_xlabel, bw_ylabel, bw_colormap, gridstatus, bw_legend, error_sides, legend_type)
...
try
    ...
    if size(barvalues,1) ~= size(errors,1) || size(barvalues,2) ~= size(errors,2)
        ...
        set(gca, 'xticklabel', groupnames, 'box', 'on', 'fontsize', 10, 'xtick',1:numgroups, 'linewidth', 1,'xgrid','off','ygrid','off');
