...
#read in stimuli
if subj_id == 999:
    trial_data_999 = [r for r in csv.DictReader(open('params/999_design.csv','rU'))]
    trials_run999 = data.TrialHandler(trial_data_999[:], 1, method="sequential") #change to [] for full run
'''
